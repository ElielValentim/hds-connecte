...
const RecoverPassword = () => {
  ...
  const { recoverPassword, signInWithGoogle, isLoading } = useAuthStore();
          ...
          <CardHeader>
            ...
            <CardDescription>
              {isSubmitted
                ...
                : 'Faça login com sua conta Google para recuperar seu acesso.'}
            </CardDescription>
          </CardHeader>
          ...
          {!isSubmitted ? (
            ...
            <CardContent className="text-center space-y-4">
              <div className="p-4 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 rounded-md">
                <p>Faça login com sua conta Google para acessar sua conta.</p>
              </div>
